...
public partial class ProfileAuditDbContext : DbContext
{
    public ProfileAuditDbContext()
    {
    }

    public ProfileAuditDbContext(DbContextOptions<ProfileAuditDbContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server=COGNINE-L181\\SQLEXPRESS;Database=ProfileAuditDB;Trusted_Connection=SSPI;Encrypt=false;TrustServerCertificate=true");
